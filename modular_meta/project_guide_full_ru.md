...
Если модуль маленький и файлов мало, то никто не мешает расположить основные файлы без системы подпапок.
...
Также учтите, что вы не сможете при модульном дополнении функции использовать те переменные, которые были объявлены в функции оригинале! (<- !провести факт-чеккинг!)
